...
export function validateDocument(input){
  ...
  for(const e of edges){takeId(e,"edge");if(!endpointOk(e.from)||!endpointOk(e.to)||!["straight","orthogonal"].includes(e.routing)||typeof e.label!=="string"||e.label.length>500||!styleOk(e.style))errors.push(`Invalid edge ${e.id}.`)}
